...
# Aplica PCA con todos los componentes
pca = PCA()
pca.fit(scaled_data)
...
# Gráfica la varianza explicada acumulada
plt.figure()
...
n_components = np.where(varianza_acumulada >= 0.95)[0][0] + 1

print("Número mínimo de componentes para explicar al menos el 95% de la varianza:", n_components)
